<?php namespace Euw\FacebookApp\Modules\Invitations\Repositories;

use Euw\MultiTenancy\Contexts\Context;
use Illuminate\Database\Eloquent\Model;
use Euw\MultiTenancy\Modules\Tenants\Repositories\TenantRepository;

class EloquentInvitationRepository extends TenantRepository implements InvitationRepository
{
